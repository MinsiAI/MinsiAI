...
An AI-powered platform designed to support students through emotional reflection, stress management, and safe digital interaction.  
**Focus areas:** Affective Computing · Emotional Well-being · Digital Identity · Youth-Centered AI

### 🧠 AI & LLM Experiments
Exploring how large language models can be used in empathetic conversations, journaling experiences, and emotionally aware product design.
...
### [Minsi AI](https://minsi.ai)
A student-focused AI platform for emotional support, reflection, and healthy digital growth.  
**Tech:** Next.js · Tailwind CSS · Claude  
**Status:** In active development

### Emotion-Aware Chatbot Prototype
...
Tools I currently explore for prototyping and product experimentation:
